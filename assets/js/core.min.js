...
function initQuill() {
                        ...
                        handler: function(t, e) {
                            ...
                            if (r) {
                                ...
                                if (u = s.match(/(^|\s)(https?:\/\/\S+)$/)) {
                                    ...
                                    if (d.length || a.formatText(t.index - c.length, c.length, "link", c, Quill.sources.USER),
                                    !s.substr(0, i - c.length).trim().length && "P" == r.domNode.tagName) {
    ...
    return a.addContainer($tl_link_tooltip),
    a.addContainer($tl_tooltip),
    a.addContainer($tl_blocks),
    a.on(Quill.events.EDITOR_CHANGE, function(t, e) {
        if (t === Quill.events.SELECTION_CHANGE && a.isEnabled() && null != e) {
            ...
            null == r || r instanceof FieldBlot || r instanceof BlockquoteBlot || r instanceof PullquoteBlot || r instanceof CodeBlock || r instanceof ListItem || $(r.domNode).text().length ? hideBlocksTooltip() : showBlocksTooltip(e)) : (null == r || r instanceof TitleBlot ? hideFormatTooltip() : (showFormatTooltip(e),
            toolbarUpdate(e)),
            hideBlocksTooltip());
            var i = a.getFormat(e);
            $tl_article.classList.toggle("title_focused", !(!i.blockTitle && !i.blockAuthor)),
...
function savePage() {
    ...
    updateEditable(!1);
    var $content = domToNode($tl_editor).children;
    $content[0].children.shift();
    $content[0].children.shift();
    $.ajax(T.apiUrl + "/api/v0/save/", {
          data: {
            access_token:   'a00835f8ffba511c9a71c2397c33fac4229a782cca04754026b90f0b1316',
            title:          t,
          ...
          success: function(data) {
            ...
            void (!T.pageId && t.url && (location.href = t.result.url)))
          },
          error: function(t) {
            return $tl_article.classList.remove("tl_article_saving"),
            updateEditable(!0),
...
function checkAuth() {
    T.editable && $.ajax(T.apiUrl + "/api/v0/check/", {
        data: {
            page_id: T.pageId
        },
        type: "POST",
        ...
        success: function(t) {
            ...
            !T.pageId && ($tl_article.classList.add("tl_article_edit"),
...
function toolbarUpdate(t) {
    var e = null == t ? {} : quill.getFormat(t)
      ...
      , r = !!e["code-block"];
    if ($bold_button.classList.toggle("active", !!e.bold),
    $bold_button.classList.toggle("disabled", o || l || r),
    $italic_button.classList.toggle("active", !!e.italic),
    $italic_button.classList.toggle("disabled", o || l || r),
    $header_button.classList.toggle("active", !!e.blockHeader),
    $header_button.classList.toggle("disabled", o),
    $subheader_button.classList.toggle("active", !!e.blockSubheader),
    $subheader_button.classList.toggle("disabled", o),
    $quote_button.classList.toggle("active", !(!e.blockBlockquote && !e.blockPullquote)),
    $quote_button.classList.toggle("pullquote", !!e.blockPullquote),
    $quote_button.classList.toggle("disabled", o),
    null != t) {
        var i = quill.scroll.descendants(LinkBlot, t.index, t.length);
        $link_button.classList.toggle("active", !!i.length)
    } else
        $link_button.classList.toggle("active", !1);
    $link_button.classList.toggle("disabled", r)
}
...
function updateEditable(t) {
    if ($tl_article.classList.toggle("tl_article_edit", t),
    updateEditableText(),
...
function updateReportFormState() {
    ...
    $report_form.classList.toggle("copyright_selected", "copyright" == t.reason.value),
    $report_form.classList.toggle("form_disabled", !!e),
...
function showLinkTooltip(t, e) {
    if (isEdit()) {
        ...
        $tl_link_tooltip.textContent = decodeURI(e),
        tooltipUpdatePosition($tl_link_tooltip, o, linkTTOptions),
        $tl_link_tooltip.classList.contains("move_anim") || setTimeout(function() {
            $tl_link_tooltip.classList.add("move_anim")
        }, 1),
        $tl_link_tooltip.classList.contains("shown") || setTimeout(function() {
            $tl_link_tooltip.classList.add("shown")
        }, 10)
    }
}
...
function showFormatTooltip(t) {
    isEdit() && ($tl_tooltip.classList.remove("tooltip_prompt"),
    tooltipUpdatePosition($tl_tooltip, t, formatTTOptions),
    $tl_tooltip.classList.contains("move_anim") || setTimeout(function() {
        $tl_tooltip.classList.add("move_anim")
    }, 10),
    $tl_tooltip.classList.contains("shown") ? tooltipUpdatePosition($tl_link_tooltip, null, linkTTOptions) : setTimeout(function() {
...
function showBlocksTooltip(t) {
    isEdit() && ($tl_blocks.classList.add("shown"),
...
function showAlert(t, e) {
    ...
    if (e.submit_btn) {
        ...
        i.html(e.submit_btn).click(function() {
            o.classList.add("tl_popup_loading"),
            e.submit()
        }).appendTo(l)
    }
    o.appendTo("body")
...
function showPopup(t) {
    hideAlert(),
    t.classList.remove("tl_popup_hidden")
}
function isOverElement(t, e, o) {
    if (!e || !e.classList.contains("shown"))
        return !1;
    ...
    var l = e
      , r = {
        top: l._top,
        bottom: l._top + e.offsetHeight,
        left: l._left,
        right: l._left + e.offsetWidth
    };
...
function toolbarPrompt(t, e, o) {
    ...
    t.classList.add("tooltip_prompt"),
    l.focus()
}
function toolbarPromptHide(t) {
    ...
    o.off("click"),
    t.style.display = "block",
    t.classList.remove("tooltip_prompt"),
    quill.focus()
}
...
var FigureBlot = function(t) {
    function e(t, o) {
        ...
        $(l.domCaption).on("keyup drop change input textInput paste cut", function(t) {
            l.domCaption.classList.toggle("empty", !t.target.value),
    ...
    _createClass(e, [{
        ...
        value: function(t) {
            ...
            o.appendChild(l),
            l.setAttribute("src", "https://telegra.ph" + this.sanitize(t).replace("https://telegra.ph", "")),
            ...
            _uploadFile(t, function(t, o) {
                ...
                if (o) {
                    ...
                    if ("video/" == t.type.substr(0, 6)) {
                        ...
                        r.setAttribute("src", 'https://telegra.ph' + l)
                    } else {
                        var i = e.domWrapper.querySelector("img");
                        i.setAttribute("src", 'https://telegra.ph' + l)
                    }
...
var MyQuill = function(t) {
  ...
  , $tl_page = document.querySelector(".tl_page")
  , $tl_page_footer = document.querySelector(".tl_page_footer")
  , $tl_article = document.querySelector(".tl_article")
  , $tl_editor = document.querySelector("#_tl_editor")
  , $tl_header = document.querySelector(".tl_article_header")
  , $tl_content = document.querySelector(".tl_article_content")
  , $tl_tooltip = document.querySelector("#_tl_tooltip")
  , $tl_blocks = document.querySelector("#_tl_blocks")
  , $tl_link_tooltip = document.querySelector("#_tl_link_tooltip")
  , $bold_button = document.querySelector("#_bold_button")
  , $italic_button = document.querySelector("#_italic_button")
  , $link_button = document.querySelector("#_link_button")
  , $header_button = document.querySelector("#_header_button")
  , $subheader_button = document.querySelector("#_subheader_button")
  , $quote_button = document.querySelector("#_quote_button")
  , $image_button = document.querySelector("#_image_button")
  , $embed_button = document.querySelector("#_embed_button")
  , $edit_button = document.querySelector("#_edit_button")
  , $publish_button = document.querySelector("#_publish_button")
  , $account = $(".account")
  , $error_msg = document.querySelector("#_error_msg")
  , $report_button = document.querySelector("#_report_button")
  , $report_popup = document.querySelector("#_report_popup")
  , $report_form = document.querySelector("#_report_form")
  , $report_cancel = document.querySelector("#_report_cancel")
  , formatTTOptions = {
    padding: 10,
...
$tl_tooltip.addEventListener('mouseover', function(t) {
    var e = t.target;
    "BUTTON" != t.target.tagName || t.target.classList.contains("disabled") || ($tl_tooltip.setAttribute("data-hover", e.id) || ($tl_tooltip.classList.add("hover")),
    setTimeout(function() {
        $tl_tooltip.classList.add("hover_anim")
    }, 1),
    clearTimeout($tl_tooltip.to))
}),
$tl_tooltip.addEventListener('mouseout', function(t) {
    var e = t.target;
    "BUTTON" == e.tagName && ($tl_tooltip.classList.remove("hover"),
    $tl_tooltip.to = setTimeout(function() {
        $tl_tooltip.classList.remove("hover_anim")
    }, 70))
}),
$bold_button.addEventListener('click', function(t) {
    var e = t.target
...
$italic_button.addEventListener('click', function(t) {
    var e = t.target
      , o = e.classList.contains("active");
    t.preventDefault();
    quill.getSelection(!0);
...
$link_button.addEventListener('click', function(t) {
    var e = t.target
      , o = e.classList.contains("active");
    t.preventDefault();
...
$header_button.addEventListener('click', function(t) {
    var e = t.target
      , o = e.classList.contains("active");
    t.preventDefault();
    var l = quill.getSelection(!0);
...
$subheader_button.addEventListener('click', function(t) {
    var e = t.target
      , o = e.classList.contains("active");
    t.preventDefault();
    var l = quill.getSelection(!0);
...
$quote_button.addEventListener('click', function(t) {
    var e = t.target
      , o = e.classList.contains("active")
...
$embed_button.addEventListener('click', function(t) {
...
$report_form.addEventListener('submit', function(t) {
    t.preventDefault(),
    sendReport()
}),
...
(new Image).src = window.devicePixelRatio >= 2 ? "/images/icons_2x.png?1" : T.apiUrl + "/front/assets/images/icons.png"; //change url to icons.png
var quill = initQuill()
  , pageContent = !1;
browser.mobile && $(document.body).classList.add("mobile"),
checkAuth();