!function(t, e) {
        ...
        var o = this && this.__extends || function(t, e) {
          ...
          , s = function(t) {
            ...
            e.prototype.attach = function() {
                ...
                [].slice.call(this.domNode.childNodes).reverse().forEach(function(t) {
                    try {
                        ...
                        if (o instanceof a.ParchmentError)
                            return;
                        throw o
                    }
                })
            ...
            e.prototype.optimize = function() {
                if (t.prototype.optimize.call(this),
            ...
            e.prototype.update = function(t) {
                ...
                t.forEach(function(t) {
                    t.target === e.domNode && "childList" === t.type && (n.push.apply(n, t.addedNodes),
                ...
                n.filter(function(t) {
                    ...
                    var o = r(t);
                    o.next == n && null != o.next || (null != o.parent && o.parent.removeChild(e),
                    e.insertBefore(o, n))
                })
            }
            ,
        ...
        var r = n(6)
          , o = function() {
            ...
            t.prototype.insertInto = function(t, e) {
                ...
                null != e)
                    var n = e.domNode;
                null != this.next && this.domNode.nextSibling == n || t.domNode.insertBefore(this.domNode, n),
                this.parent = t
            }
            ,
    ...
    , function(t, e) {
        ...
        function r(t, n) {
            return void 0 === n && (n = !1),
            null == t ? null : null != t[e.DATA_KEY] ? t[e.DATA_KEY].blot : n ? r(t.parentNode, n) : null
        }
        function o(t, e) {
            void 0 === e && (e = p.ANY);
            var n;
            if ("string" == typeof t)
                ...
                t & p.LEVEL & p.BLOCK ? n = f.block : t & p.LEVEL & p.INLINE && (n = f.inline);
        ...
        function i() {
            ...
            if (f[n.blotName || n.attrName] = n,
            "string" == typeof n.keyName)
                s[n.keyName] = n;
            else if (null != n.className && (u[n.className] = n),
            null != n.tagName) {
          ...
          , s = function(t) {
            ...
            e.prototype.optimize = function(e) {
                ...
                for (var r = function(t, e) {
                    void 0 === e && (e = !0),
                    null != t && t !== n && null != t.domNode.parentNode && (null == t.domNode[i.DATA_KEY].mutations && (t.domNode[i.DATA_KEY].mutations = []),
                    e && r(t.parent))
                }, l = function(t) {
                    null != t.domNode[i.DATA_KEY] && null != t.domNode[i.DATA_KEY].mutations && (t instanceof o["default"] && t.children.forEach(l),
                    t.optimize())
                    ...
                    s.forEach(function(t) {
                        ...
                        null != e && (e.domNode === t.target && ("childList" === t.type ? (r(i.find(t.previousSibling, !1)),
            ...
            e.prototype.update = function(e) {
                ...
                e.map(function(t) {
                    var e = i.find(t.target, !0);
                    if (null != e)
                        return null == e.domNode[i.DATA_KEY].mutations ? (e.domNode[i.DATA_KEY].mutations = [t],
                        e) : (e.domNode[i.DATA_KEY].mutations.push(t),
                        null)
                }).forEach(function(t) {
                    null != t && t !== n && null != t.domNode[i.DATA_KEY] && t.update(t.domNode[i.DATA_KEY].mutations || [])
                }),
                null != this.domNode[i.DATA_KEY].mutations && t.prototype.update.call(this, this.domNode[i.DATA_KEY].mutations),
                this.optimize(e)
            }
            ,
            e.blotName = "scroll",
          ...
          , a = function(t) {
            ...
            e.prototype.optimize = function() {
                ...
                if (0 === Object.keys(n).length)
                    return this.unwrap();
                var o = this.next;
                o instanceof e && o.prev === this && r(n, o.formats()) && (o.moveChildren(this),
                o.remove())
            }
            ,
            e.blotName = "inline",
    ...
    , function(t, e, n) {
        ...
        function s(t, e, n, r, o) {
            ...
            n = e,
            e = 0),
            "object" === ("undefined" == typeof n ? "undefined" : c(n)) ? (i = n,
        ...
        N["default"])("quill")
          , S = function() {
            function t(e) {
                ...
                this.updatePhoto = this.options.updatePhoto || function(t, e) {
                    e && e(t)
                }
                ;
            ...
            return p(t, null, [{
                ...
                value: function(t, e) {
                    ...
                    if ("string" != typeof t) {
                        ...
                        this.imports[t] = e,
                        (t.startsWith("blots/") || t.startsWith("formats/")) && "abstract" !== e.blotName && w["default"].register(e);
                }
            }]),
            p(t, [{
                key: "addContainer",
    ...
    , function(t, e) {
        ...
        n.classList.contains("test-class") && !function() {
    ...
    , function(t, e, n) {
        ...
        s.prototype.insert = function(t, e) {
            ...
            e instanceof Object && Object.keys(e).length > 0 && (n.attributes = e),
            this.push(n))
        }
        ,
        ...
        s.prototype.retain = function(t, e) {
            ...
            return e instanceof Object && Object.keys(e).length > 0 && (n.attributes = e),
            this.push(n)
        }
        ,
        ...
        s.prototype.diff = function(t, e) {
            ...
            var n = [this, t].map(function(e) {
                return e.map(function(e) {
                    if (null != e.insert)
                        return "string" == typeof e.insert ? e.insert : a;
        ...
        s.prototype.eachLine = function(t, e) {
            ...
            for (var n = l.iterator(this.ops), r = new s; n.hasNext(); ) {
                ...
                a < 0 ? r.push(n.next()) : a > 0 ? r.push(n.next(a)) : (t(r, n.next(1).attributes || {}),
                r = new s)
            }
            r.length() > 0 && t(r, {})
        }
    ...
    , function(t, e) {
        ...
        function r(t, e) {
            ...
            var i = t.length > e.length ? t : e
              ...
              , a = i.indexOf(l);
            if (a != -1)
                return r = [[d, i.substring(0, a)], [y, l], [d, i.substring(a + l.length)]],
        ...
        function o(t, e) {
            ...
            for (var f = n - r, p = f % 2 != 0, y = 0, v = 0, b = 0, g = 0, m = 0; m < o; m++) {
                ...
                for (var j = -m + b; j <= m - g; j += 2) {
                    ...
                    for (var A = E - j; E < n && A < r && t.charAt(n - E - 1) == e.charAt(r - A - 1); )
                        E++,
                        A++;
                    if (u[k] = E,
                    E > n)
        ...
        function s(t, e) {
            function n(t, e, n) {
                for (var r, o, i, s, u = t.substring(n, n + Math.floor(t.length / 4)), c = -1, f = ""; (c = e.indexOf(u, c + 1)) != -1; ) {
                    ...
                    f.length < h + p && (f = e.substring(c - h, c) + e.substring(c, c + p),
                    r = t.substring(0, n - h),
                    o = t.substring(n + p),
                    i = e.substring(0, c - h),
                    s = e.substring(c + p))
        ...
        function u(t) {
            ...
            for (var e, n = 0, r = 0, o = 0, i = "", s = ""; n < t.length; )
                ...
                case y:
                    ...
                    0 !== e && (n - r - o > 0 && t[n - r - o - 1][0] == y ? t[n - r - o - 1][1] += s.substring(0, e) : (t.splice(0, 0, [y, s.substring(0, e)]),
                    n++),
                    s = s.substring(e),
                    i = i.substring(e)),
                    e = a(s, i),
                    0 !== e && (t[n][1] = s.substring(s.length - e) + t[n][1],
                    s = s.substring(0, s.length - e),
                    i = i.substring(0, i.length - e))),
                    0 === r ? t.splice(n - o, r + o, [d, s]) : 0 === o ? t.splice(n - r, r + o, [h, i]) : t.splice(n - r - o, r + o, [h, i], [d, s]),
                    n = n - r - o + (r ? 1 : 0) + (o ? 1 : 0) + 1) : 0 !== n && t[n - 1][0] == y ? (t[n - 1][1] += t[n][1],
                    t.splice(n, 1)) : n++,
                    o = 0,
                    r = 0,
                    i = "",
            ...
            for (n = 1; n < t.length - 1; )
                t[n - 1][0] == y && t[n + 1][0] == y && (t[n][1].substring(t[n][1].length - t[n - 1][1].length) == t[n - 1][1] ? (t[n][1] = t[n - 1][1] + t[n][1].substring(0, t[n][1].length - t[n - 1][1].length),
    ...
    , function(t, e) {
        ...
        t.exports = function l() {
            var t, e, n, r, a, s, u = arguments[0], c = 1, f = arguments.length, p = !1;
            for ("boolean" == typeof u ? (p = u,
            u = arguments[1] || {},
            c = 2) : ("object" != typeof u && "function" != typeof u || null == u) && (u = {}); c < f; ++c)
                if (t = arguments[c],
                null != t)
                    for (e in t)
                        n = u[e],
                        r = t[e],
                        u !== r && (p && r && (i(r) || (a = o(r))) ? (a ? (a = !1,
                        s = n && o(n) ? n : []) : s = n && i(n) ? n : {},
                        u[e] = l(p, s, r)) : "undefined" != typeof r && (u[e] = r));
            return u
        }
    }
    , function(t, e, n) {
    ...
    , function(t, e, n) {
        ...
        function a(t) {
            return t.reduce(function(t, e) {
                if (1 === e.insert) {
                    var n = (0,
                    k["default"])(e.attributes);
                    return delete n.image,
                    t.insert({
                        image: e.attributes.image
                    }, n)
                }
                if (null == e.attributes || e.attributes.list !== !0 && e.attributes.bullet !== !0 || (e = (0,
                k["default"])(e),
          ...
          , q = function() {
            ...
            return c(t, [{
                ...
                value: function(t, e) {
                    ...
                    this.update((new p["default"]).retain(t)["delete"](e))
                }
            }, {
                key: "formatLine",
                value: function(t, e) {
                    ...
                    this.scroll.optimize(),
                    this.update((new p["default"]).retain(t).retain(e, (0,
                    k["default"])(r)))
                }
            }, {
                key: "formatText",
                ...
                value: function(t, e, n) {
                    ...
                    this.update((new p["default"]).retain(t).insert(o({}, e, n)))
                }
            }, {
                key: "insertText",
                value: function(t, e) {
                    ...
                    this.update((new p["default"]).retain(t).insert(e, (0,
                    k["default"])(r)))
                }
            }, {
                key: "isBlank",
                ...
                value: function(t) {
                    ...
                    t && (0,
                    j["default"])(o.compose(t), this.delta) || (t = o.diff(this.delta, r))),
                    t
                }
            }]),
            t
        ...
        var O = function(t) {
            ...
            s(e, [{
                ...
                value: function() {
                    ...
                    var t = this.next;
                    null != t && t.prev === this && t.statics.blotName === this.statics.blotName && this.statics.formats(this.domNode) === t.statics.formats(t.domNode) && (t.optimize(),
                    t.moveChildren(this),
                    t.remove())
                }
            }, {
    ...
    , function(t, e, n) {
        ...
        var j = function(t) {
            ...
            s(e, [{
                ...
                key: "length",
                value: function() {
                    return null == this.cache.length && (this.cache.length = u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "length", this).call(this) + k),
                    this.cache.length
                }
            }, {
                key: "moveChildren",
    ...
    , function(t, e, n) {
        ...
        var a = function() {
          ...
          , y = function(t) {
            ...
            a(e, [{
                ...
                key: "optimize",
                value: function() {
                    if (s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this),
        ...
        y.allowedChildren = [y, c["default"], p["default"]],
        y.order = ["cursor", "inline", "code", "underline", "strike", "italic", "bold", "script", "link"],
        e["default"] = y
    }
    , function(t, e, n) {
        "use strict";
                ...
                value: function() {
                    ...
                    if (!this.selection.composing && null != this.parent) {
                        ...
                        if (this.textNode.data !== e.CONTENTS) {
                            ...
                            this.next instanceof y["default"] ? (o = this.next.domNode,
                        ...
                        this.remove(),
                        null != i && this.selection.emitter.once(b["default"].events.SCROLL_OPTIMIZE, function() {
                            ...
                            i = n[0],
                            l = n[1],
                            t.selection.setNativeRange(o, i, o, l)
                        })
                    }
                }
            }, {
            ...
            function t(e, n, r, o) {
                function a(e, r) {
                    ...
                    if (e instanceof l)
                        ...
                        c = new RegExp(e.source,i(e)),
                        e.lastIndex && (c.lastIndex = e.lastIndex);
                    else if (t.__isDate(e))
                        c = new Date(e.getTime());
                    else {
                        if (h && Buffer.isBuffer(e))
                            return c = new Buffer(e.length),
                            e.copy(c),
                            c;
                        "undefined" == typeof o ? (d = Object.getPrototypeOf(e),
                        c = Object.create(d)) : (c = Object.create(o),
                        d = o)
                    }
                    if (n) {
                        var y = f.indexOf(e);
                    ...
                    for (var w in e) {
                        var x;
                        d && (x = Object.getOwnPropertyDescriptor(d, w)),
                        x && null == x.set || (c[w] = a(e[w], r - 1))
                    }
        ...
        g["default"])("quill:selection")
          ...
          , O = function() {
            function t(e, n) {
                ...
                ["keyup", "mouseup", "mouseleave", "touchend", "touchleave", "focus", "blur"].forEach(function(t) {
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    if (e > 0) {
                        ...
                        var b = "left"
                          , g = void 0;
                        o instanceof Text ? (u < o.data.length ? (p.setStart(o, u),
                        p.setEnd(o, u + 1)) : (p.setStart(o, u - 1),
                        p.setEnd(o, u),
                        b = "right"),
                        g = p.getBoundingClientRect()) : (g = s.domNode.getBoundingClientRect(),
                        u > 0 && (b = "right")),
                        r = {
                            height: g.height,
                            left: g[b],
                ...
                value: function() {
                    ...
                    if (null == e)
                        return null;
                    if (!l(this.root, e.startContainer) || !e.collapsed && !l(this.root, e.endContainer))
                        return null;
                    var n = {
                        start: {
                ...
                value: function() {
                    ...
                    if (null != t) {
                        ...
                        if (null != e) {
                            var n = function(t) {
                                for (var e = t.offsetTop; t = t.offsetParent; )
                                    e += t.offsetTop;
                                return e
                            }
                              , r = n(this.root)
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : v["default"].sources.USER
                      ...
                      , r = this.getRange()
                      , o = a(r, 2);
                    if (this.lastRange = o[0],
                    e = o[1],
                    null != this.lastRange && (this.savedRange = this.lastRange),
                    !(0,
                    d["default"])(n, this.lastRange)) {
                        var i;
                        !this.composing && null != e && e["native"].collapsed && e.start.node !== this.cursor.textNode && this.cursor.restore();
                        var l = [v["default"].events.SELECTION_CHANGE, (0,
                        p["default"])(this.lastRange), (0,
                        p["default"])(n), t];
                        if ((i = this.emitter).emit.apply(i, [v["default"].events.EDITOR_CHANGE].concat(l)),
          ...
          , x = function(t) {
            ...
            u(e, [{
                ...
                value: function(t, n) {
                    ...
                    null != f && i !== f && l > 0 && !(i instanceof y.BlockEmbed) && !(f instanceof y.BlockEmbed)) {
                    ...
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0
                      ...
                      , n = function r(t, e, n) {
                        ...
                        return t.children.forEachAt(e, n, function(t, e, n) {
                            a(t) ? o.push(t) : t instanceof p["default"].Container && (o = o.concat(r(t, e, i))),
                            i -= n
                        }),
                        o
                    };
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
                    this.batch !== !0 && (c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this, t),
                    t.length > 0 && this.emitter.emit(d["default"].events.SCROLL_OPTIMIZE, t))
                }
            }, {
                key: "path",
                value: function(t) {
    ...
    , function(t, e, n) {
        ...
        function h(t, e) {
            ...
            return n.concat(r).concat(o).forEach(function(e) {
                ...
                i[n.attrName]) || (null != H[e] && (n = H[e],
                i[n.attrName] = n.value(t)),
                null != F[e] && (n = F[e],
                i[n.attrName] = n.value(t)))
            }),
            Object.keys(i).length > 0 && (e = e.compose((new k["default"]).retain(e.length(), i))),
            e
        }
        function d(t, e) {
        ...
        function m(t, e) {
            var n = {}
              , r = t.style || {};
            return r.fontWeight && "bold" === u(t).fontWeight && (n.bold = !0),
            Object.keys(n).length > 0 && (e = e.compose((new k["default"]).retain(e.length(), n))),
            parseFloat(r.textIndent || 0) > 0 && (e = (new k["default"]).insert("\t").concat(e)),
            e
        }
        function _(t, e) {
            var n = t.data;
        ...
        var O = function() {
          ...
          , B = n(50)
          , D = (0,
        T["default"])("quill:clipboard")
          , U = [[Node.TEXT_NODE, _], ["br", y], [Node.ELEMENT_NODE, b], [Node.ELEMENT_NODE, d], [Node.ELEMENT_NODE, g], [Node.ELEMENT_NODE, h], [Node.ELEMENT_NODE, m], ["b", p.bind(p, "bold")], ["i", p.bind(p, "italic")], ["style", v]]
            ...
            w(e, [{
                ...
                value: function(t) {
                    ...
                    var i = function a(t) {
                      ...
                      , l = i(this.container);
                    return c(l, "\n") && null == l.ops[l.ops.length - 1].attributes && (l = l.compose((new k["default"]).retain(l.length() - 1)["delete"](1))),
                ...
                value: function(t) {
                    ...
                    if (!t.defaultPrevented && this.quill.isEnabled()) {
                        var n, r = this.quill.getSelection(), o = this.quill.getBounds(r), i = (new k["default"]).retain(r.index)["delete"](r.length), l = !1, a = document.documentElement.scrollTop, s = function(t) {
                            e.container.focus(),
                            e.quill.selection.update(N["default"].sources.SILENT),
                            i = i.concat(t),
                            e.quill.updateContents(i, N["default"].sources.USER),
                            e.quill.setSelection(i.length() - r.length, N["default"].sources.SILENT),
                            document.documentElement.scrollTop = a,
                            e.quill.selection.scrollIntoView(),
                            e.quill.emitter.emit(e.quill.emitter.constructor.events.TEXT_PASTE, i, N["default"].sources.USER)
                        };
                            ...
                            for (var u = 0; u < n.length; u++)
                                if ("file" == n[u].kind && 0 == n[u].type.indexOf("image/")) {
                                    ...
                                    e.quill.updatePhoto(c, function(t) {
                                        if (e.quill.fileSizeLimit && t.size > e.quill.fileSizeLimit)
                                            return void (e.quill.fileSizeLimitCallback && e.quill.fileSizeLimitCallback());
                                        var n = new FileReader;
                                        n.onload = function(t) {
                                            var n = document.createElement("img");
                                            n.src = t.target.result,
                                            s(e.convert(n.outerHTML))
                                        }
                                        ,
                                        n.readAsDataURL(t)
                                    }),
                        ...
                        l || (this.container.style.top = o.top + "px",
    ...
    , function(t, e, n) {
        ...
        function a(t, e) {
            if (0 !== t.index) {
                ...
                Object.keys(i).length > 0 && this.quill.formatLine(t.index - 1, 1, i, N["default"].sources.USER),
                this.quill.selection.scrollIntoView()
            }
        }
        function s(t) {
        ...
        function u(t) {
            this.quill.deleteText(t, N["default"].sources.USER),
            this.quill.setSelection(t.index, N["default"].sources.SILENT),
            this.quill.selection.scrollIntoView()
        }
        function c(t, e) {
            var n = this;
            ...
            var r = Object.keys(e.format).reduce(function(t, n) {
                return j["default"].query(n, j["default"].Scope.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]),
                t
            }, {});
            this.quill.insertText(t.index, "\n", r, N["default"].sources.USER),
            this.quill.selection.scrollIntoView(),
            ...
            return {
                ...
                handler: function(e) {
                    ...
                    if (null != a) {
                        ...
                        this.quill.setSelection(r, o, N["default"].sources.SILENT)
                    }
                }
            }
        }
        ...
        function h(t) {
            ...
            if ("object" === ("undefined" == typeof t ? "undefined" : d(t)) && (t = (0,
            g["default"])(t, !1)),
            "string" == typeof t.key)
        ...
        T["default"])("quill:keyboard")
          ...
          , M = function(t) {
            function e(t, n) {
                ...
                /Trident/i.test(navigator.userAgent) && (r.addBinding({
                    key: e.keys.BACKSPACE,
                    shortKey: !0
                }, a),
                r.addBinding({
            ...
            v(e, null, [{
                ...
                value: function(t, e) {
                    return e = h(e),
                    (!!e.shortKey === t[C] || null === e.shortKey) && (!["altKey", "ctrlKey", "metaKey", "shiftKey"].some(function(n) {
                                    ...
                                    var l = t.quill.scroll.line(i.index)
                                      ...
                                      , k = o.some(function(e) {
                                        ...
                                        if (Array.isArray(e.format)) {
                                            ...
                                            return e.format[t] === !0 ? null != x.format[t] : e.format[t] === !1 ? null == x.format[t] : (0,
                                            _["default"])(e.format[t], x.format[t])
                                        }))
                                            return !1;
            ...
            bindings: {
                ...
                tab: {
                    ...
                    handler: function(t, e) {
                        ...
                        this.quill.insertText(t.index, "\t", N["default"].sources.USER),
                        this.quill.setSelection(t.index + 1, N["default"].sources.SILENT)
                    }
                },
                "list empty enter": {
                    key: M.keys.ENTER,
                    ...
                    handler: function(t, e) {
                        ...
                        e.format.indent && this.quill.format("indent", !1, N["default"].sources.USER)
                    }
                },
                "header enter": {
                    key: M.keys.ENTER,
                    ...
                    handler: function(t) {
                        ...
                        this.quill.formatText(t.index + 1, 1, "header", !1, N["default"].sources.USER),
                        this.quill.setSelection(t.index + 1, N["default"].sources.SILENT),
                        this.quill.selection.scrollIntoView()
                    }
                },
                "list autofill": {
                    ...
                    handler: function(t, e) {
                        ...
                        this.quill.formatLine(t.index - n, 1, "list", 1 === n ? "bullet" : "ordered", N["default"].sources.USER),
                        this.quill.setSelection(t.index - n, N["default"].sources.SILENT)
                    }
                }
            }
        },
          ...
          , f = function(t) {
            ...
            a(e, [{
                ...
                value: function(t, n) {
                    ...
                    !0) : s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "add", this).call(this, t, n)
                }
            }, {
                key: "value",
                value: function(t) {
        ...
        var b = function(t) {
            ...
            s(e, [{
                ...
                value: function() {
                    u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this);
                    var t = this.next;
                    null != t && t.prev === this && t.statics.blotName === this.statics.blotName && t.domNode.tagName === this.domNode.tagName && (t.moveChildren(this),
                    t.remove())
                }
            }, {
                key: "replace",
                ...
                key: "create",
                value: function(t) {
                    return "ordered" === t ? t = "OL" : "bullet" === t && (t = "UL"),
        ...
        var a = function() {
          ...
          , f = function(t) {
            ...
            a(e, [{
                key: "optimize",
                value: function() {
                    s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this),
        ...
        var s = function() {
          ...
          , p = function(t) {
            ...
            s(e, [{
                key: "format",
                value: function(t, n) {
                    return t === this.statics.blotName && n ? (n = this.constructor.sanitize(n),
                    void this.domNode.setAttribute("href", n)) : u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "format", this).call(this, t, n)
                }
            }], [{
                key: "create",
                value: function(t) {
        ...
        var a = function() {
          ...
          , h = function(t) {
            ...
            a(e, [{
                ...
                value: function(t) {
                    return (0,
                    f.sanitize)(t, ["http", "https", "data"]) ? t : "//:0"
                }
            }, {
                key: "value",
                value: function(t) {
            ...
            a(e, [{
                ...
                value: function(t) {
                    if (this.cachedHTML !== this.domNode.innerHTML) {
                        ...
                        (e.trim().length > 0 || null == this.cachedHTML) && (this.domNode.innerHTML = t(e),
                        this.attach()),
        ...
        var g = new c["default"].Attributor.Class("token","hljs",{
          ...
          , m = function(t) {
            function e(t, n) {
                ...
                p["default"].register(g, !0),
                p["default"].register(b, !0);
                var l = null;
            ...
            a(e, [{
                ...
                value: function() {
                    ...
                    if (!this.quill.selection.composing) {
                        ...
                        this.quill.update(p["default"].sources.SILENT),
                        null != e && this.quill.setSelection(e, p["default"].sources.SILENT)
                    }
                }
            }]),
            e
    ...
    , function(t, e, n) {
        ...
        function c(t, e, n) {
            ...
            n.forEach(function(t) {
                ...
                t !== !1 ? e.setAttribute("value", t) : e.setAttribute("selected", "selected"),
                r.appendChild(e)
            }),
            t.appendChild(r)
        }
            ...
            handlers: {
                ...
                indent: function E(t) {
                    ...
                    if ("+1" === t || "-1" === t) {
                        var r = "+1" === t ? 1 : -1;
                        "rtl" === n.direction && (r *= -1),
                        this.quill.format("indent", E + r, g["default"].sources.USER)
                    }
                }
            }
        },
          ...
          , u = function() {
            ...
            return l(t, [{
                ...
                value: function(t) {
                    ...
                    if (t !== n)
                        if (null != n && n.classList.remove("ql-selected"),
                        null != t) {
                            if (t.classList.add("ql-selected"),
        ...
        var r = function() {
          ...
          , o = function() {
            function t(e, r) {
                ...
                n(this, t),
                this.quill = e,
                this.boundsContainer = r || document.body,
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    var r = this.boundsContainer.getBoundingClientRect()
                      ...
                      , i = 0;
                    return o.right > r.right && (i = r.right - o.right,
    ...
    , function(t, e, n) {
          ...
          , b = function(t) {
            ...
            s(e, [{
                ...
                value: function(t) {
                    ...
                    this.buildButtons([].slice.call(t.container.querySelectorAll("button"))),
                    this.buildPickers([].slice.call(t.container.querySelectorAll("select")))
                }
            }]),
            e
        }(d["default"]);
        ...
        g.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-close"></a>', "</div>"].join(""),
        e["default"] = b
    }
    , function(t, e, n) {
        "use strict";
        ...
        var s = function() {
          ...
          , M = function(t) {
            function e(t, n) {
                ...
                var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n))
                  , l = function a(e) {
                    return document.body.contains(t.root) ? (null == r.tooltip || r.tooltip.root.contains(e.target) || document.activeElement === r.tooltip.textbox || r.quill.hasFocus() || r.tooltip.hide(),
                    void (null != r.pickers && r.pickers.forEach(function(t) {
                ...
                value: function(t) {
                    t.forEach(function(t) {
                        ...
                        e.split(/\s+/).forEach(function(e) {
                            if (e.startsWith("ql-") && (e = e.slice("ql-".length),
                            null != q["default"][e]))
                                if ("direction" === e)
                                    t.innerHTML = q["default"][e][""] + q["default"][e].rtl;
                ...
                value: function(t) {
                    ...
                    this.pickers = t.map(function(t) {
                        if (t.classList.contains("ql-align"))
                            return null == t.querySelector("option") && a(t, T),
                        ...
                        if (t.classList.contains("ql-background") || t.classList.contains("ql-color")) {
                            ...
                            return null == t.querySelector("option") && a(t, P, "background" === e ? "#ffffff" : "#000000"),
                            new O["default"](t,q["default"][e])
                        }
                        return null == t.querySelector("option") && (t.classList.contains("ql-font") ? a(t, S) : t.classList.contains("ql-header") ? a(t, L) : t.classList.contains("ql-size") && a(t, C)),
                        new E["default"](t)
                    });
                    var n = function() {
        ...
        M.DEFAULTS = (0,
        f["default"])(!0, {}, m["default"].DEFAULTS, {
            modules: {
                toolbar: {
                    handlers: {
                        formula: function() {
                            ...
                            e.addEventListener("change", function() {
                                if (null != e.files && null != e.files[0]) {
                                    ...
                                    t.quill.updatePhoto(n, function(n) {
                                        if (t.quill.fileSizeLimit && n.size > t.quill.fileSizeLimit)
                                            return void (t.quill.fileSizeLimitCallback && t.quill.fileSizeLimitCallback());
            ...
            s(e, [{
                ...
                value: function() {
                    ...
                    this.textbox.addEventListener("keydown", function(e) {
                        b["default"].match(e, "enter") ? (t.save(),
                        e.preventDefault()) : b["default"].match(e, "escape") && (t.cancel(),
                        e.preventDefault())
                    })
                }
            }, {
                ...
                value: function() {
                    ...
                    case "link":
                        ...
                        this.linkRange ? (this.quill.formatText(this.linkRange, "link", t, y["default"].sources.USER),
                        delete this.linkRange) : (this.restoreFocus(),
                        this.quill.format("link", t, y["default"].sources.USER)),
                    ...
                    case "formula":
                        var r = this.quill.getSelection(!0)
                          , o = r.index + r.length;
                        null != r && (this.quill.insertEmbed(o, this.root.getAttribute("data-mode"), t, y["default"].sources.USER),
                        "formula" === this.root.getAttribute("data-mode") && this.quill.insertText(o + 1, " ", y["default"].sources.USER),
                        this.quill.setSelection(o + 2, y["default"].sources.USER))
                    }
                    this.textbox.value = "",
                    this.hide()
                }
    ...
    , function(t, e, n) {
        ...
        var a = function() {
          ...
          , _ = function(t) {
            function e(t, n) {
                o(this, e),
                null != n.modules.toolbar && null == n.modules.toolbar.container && (n.modules.toolbar.container = m);
                var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
            ...
            u(e, [{
                ...
                value: function() {
                    ...
                    this.root.querySelector("a.ql-remove").addEventListener("click", function(e) {
                        null != t.linkRange && (t.restoreFocus(),
                        t.quill.formatText(t.linkRange, "link", !1, h["default"].sources.USER),
                        delete t.linkRange),
                        e.preventDefault(),
                        t.hide()
                    }),
                        ...
                        if (null != e) {
                            if (0 === e.length) {
                                ...
                                if (null != o) {
                                    ...
                                    return t.preview.textContent = l,
        ...
        O.TEMPLATE = ['<a class="ql-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""),
        e["default"] = _
    }
    ])
});
