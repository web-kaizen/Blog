...
function initQuill() {
    ...
    a.on(Quill.events.EDITOR_CHANGE, function(t, e) {
        if (t === Quill.events.SELECTION_CHANGE && a.isEnabled() && null != e) {
            ...
            hideBlocksTooltip());
            var i = a.getFormat(e);
            $tl_article.toggleClass("title_focused", !(!i.blockTitle && !i.blockAuthor)),
...
$link_button.on('click', function(t) {
    var e = t.target
      , o = e.classList.contains("active");
    t.preventDefault();
...
$embed_button.on('click', function(t) {
...
(new Image).src = window.devicePixelRatio >= 2 ? "/images/icons_2x.png?1" : T.apiUrl + "/static/images/icons.png"; //change url to icons.png
var quill = initQuill()
  , pageContent = !1;
