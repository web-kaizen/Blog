...
/***/ function(module, exports, __webpack_require__) {
	...
	var Selection = function () {
	  ...
	  _createClass(Selection, [{
        ...
        var rangeTop = bounds.top + rootOffsetTop - document.documentElement.scrollTop;
        var rangeBottom = bounds.bottom + rootOffsetTop - document.documentElement.scrollTop;
        var margin = Math.round(window.innerHeight / 5);
        if (window.innerHeight < rangeBottom) {
          ...
          document.documentElement.scrollTop = line.domNode.offsetTop + line.domNode.offsetHeight + rootOffsetTop - window.innerHeight + margin;
        } else if (rangeTop < 0) {
          ...
          document.documentElement.scrollTop = _line.domNode.offsetTop + rootOffsetTop - margin;
        }
	    }
	  }, {
	    key: 'setNativeRange',
