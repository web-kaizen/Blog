        ...
        setPos: function(t, r, n) {
            ...
            try {
                if (t.createTextRange) {
                    ...
                    e.navigator.userAgent.toLowerCase().indexOf("msie") >= 0 && (r.start = t.value.substr(0, r.start).replace(/\r/g, "").length,
                    ...
                    t.setSelectionRange && t.setSelectionRange(r.start, r.end)
            } catch (a) {}
        },
        getText: function(t) {
            return n(t).text
        ...
        selection: function(n) {
            ...
            try {
                if (e.getSelection) {
                    ...
                    return c.getRangeAt ? a = c.getRangeAt(0) : (a = r.createRange(),
                    a.setStart(c.anchorNode, c.anchorOffset),
                    a.setEnd(c.focusNode, c.focusOffset)),
                    t("<div></div>").append(a.cloneContents()).html()
                }
                if (r.selection)
                    return s ? r.selection.createRange().text : r.selection.createRange().htmlText
            } catch (o) {}
            return ""
        }
    }),
